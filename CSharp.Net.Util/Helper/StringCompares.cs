...
namespace CSharp.Net.Util
{
    internal class LevenshteinDistance
    {
        ...
        /// 统计结果  
        /// </summary>  
        private LevenshteinResult _Result;
        /// <summary>  
        /// 开始时间  
        /// </summary>  
        ...
        public void Compute()
        {
            ...
            var ms = (1 - (double)_Matrix[_Row - 1, _Column - 1] / intLength).ToString();
            if (ms.Length > 6)
                _Result.Rate = ms.Substring(0, 6);
            else
                _Result.Rate = ms;
