...
namespace CSharp.Net.Standard.Util
{
    ...
    public class RegexHelper
    {
        ...
        **/
        ...
        {
            var regex = new Regex(@"^(0|86|17951)?(13[0-9]|15[0-9]|17[0-9]|18[0-9]|14[5678]|166|19[89])[0-9]{8}$");
        ...
        {
            var regex = new Regex(@"(13[0-9]|15[0-9]|17[0-9]|18[0-9]|14[5678]|166|19[89])[0-9]{8}$");
            return regex.IsMatch(phone);
        }
