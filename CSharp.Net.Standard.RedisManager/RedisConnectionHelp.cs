...
namespace CSharp.Net.Standard.RedisManager
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        private static readonly ConcurrentDictionary<RedisServiceConfig, ConnectionMultiplexer> ConnectionCache = new ConcurrentDictionary<RedisServiceConfig, ConnectionMultiplexer>();
